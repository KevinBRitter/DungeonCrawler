...
public class Introduction
{
    ...
    public void intro()
    {
        ...
        tempMessage += "and taste, of something having died in your mouth. You gagged, wondering why you’d decided \n";
        tempMessage += "to eat roadkill – or something of that nature! Then, as you opened your eyes and immediately \n";
        tempMessage += "flinched at the dim light, you remembered.  You’d spent a night out and about, partying it up, \n";
        tempMessage += "living to enjoy the college experience that so many sitcoms, tv shows, and high school talk-ups \n";
        tempMessage += "had prepared you for. The party last night was fun, what little you could remember of it. \n";
        tempMessage += "Today though? Today you wished you could die!  You remained laying down, sore and aggrieved, \n";
        ...
        tempMessage += "you the truth about them right now.  Glancing around the room again, you spotted a \n";
        tempMessage += "wooden door. Approaching it, you see that it was quite rotten, the planks moldy and cracked, \n";
